...
like newborns, on divine nature.}{Friedrich Hölderlin (1770-1843)}{The Death of Empedocles (1st version)}{
  The fundamental processes of ecological interactions, dispersal and mutations shape the dynamics of biological systems, and analogous processes acting upon economic activities have been proposed to explain economic change. This hypothesis is compelling because it explains economic change through endogenous mechanisms, but it has not yet been systematically tested.
  % 
  Building upon an analogy between economic activities and biological functional groups, we test this hypothesis in explaining the temporal dynamics of 9 elemental economic activities at the national level.
  %   
  We rely on an inverse modelling technique together with 59 years of economic data to estimate the statistical support of alternative population dynamic models. The models couple the dynamics of individual economic activities by accounting, respectively, for positive and negative interactions between themselves, their spatial dispersal, and their transformations into other economic activities, which support we compare against a logistic growth model taken as a null model.
  % 
  Over 77 countries considered, we find that the null model is rejected in 45 countries against the alternative models, and obtain a strong support for the models capturing positive interactions between national economic activities and spatial dispersal across countries. These results 
  % are in line with mechanisms proposed by the field of evolutionary economics, and 
  suggest that processes akin to those displayed in ecosystems play a significant role on the dynamics of economic systems at the national level.
  % 
  Paralleling variations across different ecosystems types, the strength-of-evidence varies across countries for each model, and might underlie differences in proximities between countries, institutional contexts and historical contingencies.
  % 
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  Interactions between biological organisms, dispersal (movement of individuals across space), and mutation of phenotypes, represent fundamental processes that drive the dynamics of ecosystems \citep{Vellend2010}, and similar eco-evolutionary processes may shape the dynamic of economic systems.
  %
  ...
  %  
  While processes acting upon economic activities, including their interactions, their spatial dispersal, and their transformations into other economic activities, are regularly documented in evolutionary economics, the significance of these processes on long-term economic change has seldom been quantified.%\todo{Talk about diffusion in the product space: \citep{Hidalgo2021}}
...
%   Nonetheless, the confrontation of the model predictions has remained mostly qualitative, in that patterns rather than full model outputs have been compared with observations.
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  Here, we investigate whether eco-evolutionary processes can quantitatively explain economic growth using an inverse modelling technique together with 59 years of data on economic activity. Relating the temporal evolution of the capital of economic activities to the temporal evolution of the biomass of functional groups within an ecosystem, we quantitatively estimate the effect of eco-evolutionary processes on the long-term development of national economies.
  % 
...
% 
% We used a gradient descent optimization method to minimise $L(\theta\hc )$. We used the library \textbf{MiniBatchInference.jl} to train the ODE parameters $\theta^{(c)_\M}$ with the gradient descent optimiser ADAM and BFGS. Both the parameters and the intitial conditions for each activities were fitted.
