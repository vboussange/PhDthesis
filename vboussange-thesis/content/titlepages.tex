...
\begin{titlepage}
	...
	\begin{tikzpicture}[remember picture,overlay]  
        % Background image     
        % Title & Subtitle 
		\node[above right,inner sep=0pt, yshift=0.25cm] at (current page.south west) (trees) {\includegraphics[height=0.5\paperheight]{AdobeStock_231608971.jpeg}};      
		\node[above = of trees,inner sep=0pt, yshift=-0.25cm]{\includegraphics[height=0.5\paperheight]{luca-bravo-A-fubu9QJxE-unsplash.jpg}};     
		...
		\node [
			...
			\node[yshift = 1cm, 
				...
				fill=white, 
				% rounded corners
				] at (current page.south east) (trees) {{\large Victor \color{ctcolortitle}\textbf{BOUSSANGE}}};      
