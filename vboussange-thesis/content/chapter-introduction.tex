...
\subsubsection*{Eco-evolutionary feedbacks in biological systems}
% 
...
Eco-evolutionary processes are difficult to observe in biological systems, and conducting controlled experiments to quantify their roles is usually not possible \cite{Pontarp2019}. As such, a deductive method, relying on forward modelling, has traditionally been used to investigate the effect of candidate processes \cite{Brummitt2020}. Along this approach, hypotheses about causal processes are embedded in a mechanistic model, wich forward integration generates predictions about their effects. % The resulting qualitative dynamics and/or quantitative predictions are validated against common intuition and empirical data, and further refined to elaborate a theory \cite{Sayama,Brummitt2020,Schmidt2009}.
% 
