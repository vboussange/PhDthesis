...
\begin{figure}[ht]%[\sidecaptionrelwidth][t]
  \centering
...
\begin{figure}[ht]
    \centering
      \includegraphics[width=\textwidth]{main/setting1_neutr_M=7.pdf}
      \caption{ 
...
\end{equation}
%
(see \nameref{sec:methods_diff-in-graphs}), where we define
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{main/pde_v3_horizontal.pdf}
...
\begin{figure}[ht]
  \centering
    \includegraphics[width=\textwidth]{main/sett2_adapt_IBM_horizontal_0.1.pdf}
...
\begin{figure}[ht] 
    \centering
      \includegraphics[width=\textwidth]{main/setting2_4plots_M=7_v4.pdf}
...
\section{Methods}
\label{sec:methods_diff-in-graphs}
...
%
We show in the \nameref{secSI:diff-in-graphs} how one can derive \cref{eq:r_theta_mf} from the general definition of assortativity given in \cref{eq:r_theta} and initially introduced in \citep{Newman2003a}.
