...
\node[mechanisms, fill=myred!30,draw=myred] (mechs2) [right=of procs2] {  };
\node[mechanisms, fill=myred!30,draw=myred] (mechs) at ([xshift=-0.2cm,yshift=-0.2cm]mechs2.center) {Mechanisms};
...
\begin{scope} [connect arrow]  % now dashed is for the lines inside the scope
    ...
    \draw ([yshift=-0.7cm]model_contour.east) to [bend right] (mechs.south); 
    \draw (mechs2.north) to [bend right] ([yshift=0.7cm]model_contour.east);
