...
\node[mechanisms,draw=black] (data) [below= 3cm of model_contour2]{ Data};
\node[mechanisms,draw=black] (prior_knowledge) [above= 3cm of model_contour]{ Prior knowledge };
\node[mechanisms,draw=black] (post_knowledge) [above= 2.9cm of mechs2]{ Posterior knowledge };
