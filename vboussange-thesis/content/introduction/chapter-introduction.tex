...
% 
Evolutionary economics, promoted by the seminal work of \cite{Veblen1898} and later by \cite{nelson1985evolutionary}, criticizes the assumption of the rationality of agents, and seeks to explain economic change by focusing on the eco-evolutionary processes acting upon firms and their organizational routines.
% 
Organizational routines designate the ensemble of behavioral or technological rules that defines the cohesive identity of the firms. They play the same roles as genes, experiencing evolutionary processes and determining firms' behavior \citep{nelson1985evolutionary}. Firms are the elemental units of economic systems \citep{nelson1985evolutionary}, and through couplings across the different organizational levels, these eco-evolutionary processes should affect economic change at the local, regional, national, and international scale (see \cref{fig:organisational_levels}).
...
% 
For instance, \cite{Saavedra2009a} has successfully used a model of mutualistic interactions to explain structural patterns in industrial cooperation.
% 
