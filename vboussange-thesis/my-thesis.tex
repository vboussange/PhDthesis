...
\label{part:I}
\input{content/diff_in_graphs/chapter-differentiation-in-graphs}   % INCLUDE: related work

\part{Scientific machine learning for eco-evolutionary modelling}
\label{part:II}
\input{content/chapter-nonlocalPDE}
\input{content/chapter-highdimpde}
\input{content/chapter-sciml}

\part{Briding eco-evolutionary models and data}
\label{part:III}
\input{content/chapter-econobiology}
